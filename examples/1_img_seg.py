...
# 1. 加载模型和处理器
model = build_sam3_image_model(checkpoint_path="/home/wsl2/sam3/test58/sam3_models/sam3.pt")
processor = Sam3Processor(model)

# 2. 加载图像并初始化推理状态
image = Image.open("/home/wsl2/sam3/test58/img.jpg")
...
image_cv = cv2.cvtColor(cv2.imread("/home/wsl2/sam3/test58/img.jpg"), cv2.COLOR_BGR2RGB)
